...
#ifndef MACE_OPS_ARM_BASE_GROUP_CONV2D_MXN_H_
#define MACE_OPS_ARM_BASE_GROUP_CONV2D_MXN_H_
...
template <typename T>
class GroupConv2dKMxN : public GroupConv2dBase {
 public:
  explicit GroupConv2dKMxN(const delegator::GroupConv2dParam &param,
                           const int tile_h,
                           const int tile_w)
      : GroupConv2dBase(param, sizeof(T)),
        out_tile_h_(tile_h),
        out_tile_w_(tile_w) {}

  virtual ~GroupConv2dKMxN() {}
...
#endif  // MACE_OPS_ARM_BASE_GROUP_CONV2D_MXN_H_
